...
def main():
    ...
    exam_01_open = [
        ...
        oq(PART_II, "d", "What the Town Centre Management scheme is?",
           ...
           "TCM = shops, local government, and citizens work together to improve the city centre (cleaner, safer, more visitors). They use TCM tools (events, marketing, also digital commerce). Money often comes from a BID — businesses pay extra for shared services.",
           "TCM — совместная работа над центром города (события, маркетинг, digital). Деньги часто через BID."),
    ...
    exam_05_open = [
        ...
        oq(PART_II, "d", "What's about Business Improvement District.",
           ...
           "BID = zone where businesses vote to pay extra tax/fee for shared services: cleaning, security, marketing, events. Funds TCM — businesses invest together in the town centre.",
           "BID — бизнес платит доп. взнос за уборку, безопасность, маркетинг. Финансирует TCM."),
