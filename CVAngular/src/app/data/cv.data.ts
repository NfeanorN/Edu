...
export const CV_PROFILE: CvProfile = {
  ...
  contacts: [
    ...
    {
      icon: '✉️',
      label: 'zhorabayevn@gmail.com',
      href: 'mailto:zhorabayevn@gmail.com',
    },
    {
      icon: '🔗',
      label: 'GitHub',
  ...
  jobs: [
    ...
    },
    {
      ...
      context:
        'Telecom software · Angular SPA and Flutter mobile app from scratch',
      responsibilities: [
  ...
  education: [
    ...
    {
      institution:
        'International University of Information Technologies (IITU), Almaty',
  ...
  languages: [
    ...
    {
      name: 'English',
      level: 'B2 (docs, work correspondence, team communication)',
    },
  ],
  additional:
